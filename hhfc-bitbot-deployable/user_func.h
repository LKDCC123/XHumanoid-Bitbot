...
extern lee::blocks::LLog<float> Logger_Policy;
...
enum Events {
  ...
  HipPitchIncrease = 4001,
  HipPitchDecrease = 4002,
  KneePitchIncrease = 4003,
  KneePitchDecrease = 4004,
  AnklePitchIncrease = 4005,
  AnklePitchDecrease = 4006,
};
...
void log_result(uint64_t cur_time, bool = false);
